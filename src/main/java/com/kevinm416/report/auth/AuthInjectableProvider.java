...
public class AuthInjectableProvider implements InjectableProvider<ShiroAuth, Parameter> {
    ...
    @Override
    public Injectable<User> getInjectable(ComponentContext ic, ShiroAuth a, Parameter c) {
