...
public class CreateShiftReport {
    ...
    private final Iterable<Long> onShift;
    private final String shift;
    private final long timeCreated;
    private final boolean keysAccountedFor;
    private final Optional<String> keysAccountedForReason;
    private final Iterable<CreateShiftReportResident> shiftReportResidents;

    @JsonCreator
    public CreateShiftReport(
            @JsonProperty("houseId") long houseId,
            @JsonProperty("onShift") Iterable<Long> onShift,
            ...
            @JsonProperty("keysAccountedForReason") Optional<String> keysAccountedForReason,
            @JsonProperty("shiftReportResidents") Iterable<CreateShiftReportResident> shiftReportResidents) {
    ...
    public Iterable<Long> getOnShift() {
        return onShift;
    }
    ...
    public Optional<String> getKeysAccountedForReason() {
